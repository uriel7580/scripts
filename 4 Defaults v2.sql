...
ALTER TABLE [dbo].[ArchivosCanvas] ADD  CONSTRAINT [DF_ArchivosCanvas_Horas] DEFAULT ((0)) FOR [Horas]
ALTER TABLE [dbo].[ArchivosCanvas] ADD  CONSTRAINT [DF_ArchivosCanvas_Destacado] DEFAULT ((0)) FOR [Destacado]
ALTER TABLE [dbo].[ArchivosCanvas] ADD  CONSTRAINT [DF_ArchivosCanvas_ComentarioDestacado] DEFAULT ('') FOR [ComentarioDestacado]
...
ALTER TABLE [dbo].[ArchivosCanvasFiltrado] ADD  CONSTRAINT [DF_ArchivosCanvasFiltrado_Horas] DEFAULT ((0)) FOR [Horas]
ALTER TABLE [dbo].[ArchivosCanvasFiltrado] ADD  CONSTRAINT [DF_ArchivosCanvasFiltrado_Destacado] DEFAULT ((0)) FOR [Destacado]
ALTER TABLE [dbo].[ArchivosCanvasFiltrado] ADD  CONSTRAINT [DF_ArchivosCanvasFiltrado_ComentarioDestacado] DEFAULT ('') FOR [ComentarioDestacado]
